...
// Ambil data mitigasi
$mitigations = $mitigation->getAllMitigations($staff_id, $is_admin);

// Ambil semua risk_code
$risk_codes = $mitigation->getAllRiskCodes($role, $staff_id);
                ...
                <table class="table-auto w-full border-collapse border border-gray-200">
                    ...
                    <tbody>
                        ...
                        if ($role === 'admin') {
                            ...
                            $query = $conn->query("SELECT mitigations.*, staffs.staff_name FROM mitigations LEFT JOIN staffs ON mitigations.staff_id = staffs.id");
                        } else {
